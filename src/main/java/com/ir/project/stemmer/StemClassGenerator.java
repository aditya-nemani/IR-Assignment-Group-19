...
public class StemClassGenerator {
    ...
    /**
     * Instantiates a new stem class generator.
     *
     * @param corpusDocPath the corpus doc path
     */
     ...
     * @param docsAsWords the docs as words
     * @return the double
     */
    ...
    /**
     * Gets the stem classes.
     *
     * @param filePath the file path
     * @return the stem classes
     */
