...
/**
 * The Class StemmedIndexer.
 */
public class StemmedIndexer {

    /**
     * Instantiates a new stemmed indexer.
     */
     ...
     * Generate index.
     *
     * @param stemmedIndexFilePath the stemmed index file path
     * @return the doc metadata and index
    ...
    /**
     * Generate doc metadata and index from document word map.
     *
     * @param documentWordMap the document word map
     * @return the doc metadata and index
     */
